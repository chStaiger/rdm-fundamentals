...
3. **Submit metadata and link the PID to a resolvable location**
   Metadata describing the object is submitted together with the identifier. This must include the **URL or landing page** where the digital object can currently be accessed. Additional elements may be added to the PID record, such as the title, checksum, or other information needed to reliably identify and manage the object.
